          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="mt-4 text-xs text-gray-500 text-center bg-slate-50 p-3 rounded-lg border border-slate-200">
              ...
              <ul className="space-y-1">
                ...
                <li>Username: <span className="font-mono bg-white px-1 border rounded">ss_cr</span> (MSc Software Systems)</li>
                <li>Username: <span className="font-mono bg-white px-1 border rounded">cs_cr</span> (MSc Cyber Security)</li>
                <li>Username: <span className="font-mono bg-white px-1 border rounded">tcs_cr</span> (MSc Theoretical CS)</li>
                <li>Username: <span className="font-mono bg-white px-1 border rounded">ds_cr</span> (MSc Data Science)</li>
              </ul>
            </div>
          </form>
        </div>
